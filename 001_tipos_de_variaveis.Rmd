...
## Exemplo:
```{r, eval=FALSE}
print("Eu comecei com R$" + 
        str(economias) + " e agora eu tenho R$" + 
        str(montante) + ". Maravilha!!!!")
```

```{r, include=FALSE}
# # Script para salvar os slides de Xaringan em pdf
# 
# #install.packages(c("pagedown", "xaringan"))
# pagedown::chrome_print(paste0(getwd(),
#                               "001_tipos_de_variaveis.Rmd")
# )
# 
...
# build_pdf(paste0(getwd(),
#                               "001_tipos_de_variaveis.Rmd"))
# build_pdf("001_tipos_de_variaveis.html")
```
